...
export async function createTurma(req, res) {
    ...
    console.log(disciplina_id, letra, semestre_id, plano_id, docente_responsavel_id, docente_secundario_id, horario, local, max_alunos, chave_acesso)
    try {
            ...
            docente_responsavel: docente_responsavel_id ? docente_responsavel_id : null, 
            docente_secundario: docente_secundario_id ? docente_secundario_id : null, 
            horario: horario, 
